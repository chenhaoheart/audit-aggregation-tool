...
class ReportPage(QWidget):
    ...
    def setup_check_result_tab(self):
        ...
        self.check_stats_label.setObjectName("statsLabel")
        ...
        self.check_result_table.setAlternatingRowColors(False)
